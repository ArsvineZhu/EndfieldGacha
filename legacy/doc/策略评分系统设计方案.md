...
这是一份历史设计归档，不是当前实现说明。当前有效实现位于 `scheduler/scoring.py`，版本为 `SCORING_VERSION = 2.3.0`。
...
- 近邻状态插值使用三次样条
- 评分缓存文件默认位于 `logs/scoring_cache.json`
- 当前评分只面向角色池，不纳入武器池
...
- `doc/implementation_records/2026-05-26-scoring-followup.md`
- `README.md`
